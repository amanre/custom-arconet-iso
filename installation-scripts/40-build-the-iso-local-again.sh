...
echo
	...
	isoLabel='custom-arconet-'$arcolinuxVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 77-1"
	buildFolder=$HOME"/custom-arconet-build"
	outFolder=$HOME"/custom-arconet-Out"
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="custom-arconet'
	newname1='iso_name="custom-arconet'

	oldname2='iso_label="custom-arconet'
	newname2='iso_label="custom-arconet'

	oldname3='custom-arconet'
	newname3='custom-arconet'

	#hostname
	oldname4='custom-arconet'
	newname4='custom-arconet'
